...
# cs100-F2018-practical7-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 7 in Computer Science 100. Since
...
* practicalseven/YearCheckerMain.java:
  * Features at least seven single-line comments
  * Features at least three multiple-line comments
  * Contains at least four uses of a `println(` statement
  * Contains at least two references to the `getHumanReadableAnswer` method
  ...
  * Produces exactly five lines of output in the terminal
  * Produces exactly one `2018` fragment in the terminal output
  * Produces exactly one `? No` fragment in the terminal output

* practicalseven/YearChecker.java:
  * Features at least four multiple-line comments
...
```
Gregory M. Kapfhammer Mon Nov 26 07:10:48 EDT 2018
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-practical7-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical7-starter)
